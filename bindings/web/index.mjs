...
/**
 * PlantUML Parser - Web/WASM Bindings for Browser Usage (ESM version)
 *
...
if (isBrowser) {
  ...
  // In Node.js, dynamically import web-tree-sitter
...
export { PlantUMLParserWeb, createParser, PlantUMLNormalizer };
