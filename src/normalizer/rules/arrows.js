 ...
 */
function hasArrowLabel(trimmed) {
 ...
 */
function validateArrow(trimmed) {
  const errors = [];
 ...
 */
function getArrowDirection(arrowType) {
  const leftArrows = [
    ARROW_TYPES.SOLID_LEFT,
    ARROW_TYPES.DASHED_LEFT,
    ARROW_TYPES.THICK_LEFT,
 ...
 */
function getArrowStyle(arrowType) {
 ...
 */
function normalizeAllArrows(lines) {
 ...
 */
function matchArrowPattern(trimmed) {
