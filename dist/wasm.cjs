...
__export(wasm_exports, {
  ...
  PlantUMLParserWasm: () => PlantUMLParserWasm,
...
// src/wasm.ts
var PlantUMLParserWasm = class _PlantUMLParserWasm extends PlantUMLParser {
  constructor(backend, options = {}) {
    super(backend, options);
  }
  static async create(options = {}) {
    const backend = await createWasmBackend({ wasmPath: options.wasmPath });
    return new _PlantUMLParserWasm(backend, options);
  }
};
